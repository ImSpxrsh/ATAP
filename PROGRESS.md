...
| Mod | What | Status |
|-----|------|--------|
| M0 | Data acquisition + MANIFEST | **partial** — cBioPortal API (BeatAML expr+mut), BeatAML2 venetoclax AUC, and **DepMap 24Q2 (expr+mut+CRISPR+Model, 228 heme lines)** all live; MANIFEST.md written. Still to add: DepMap/GDSC venetoclax/navitoclax drug sensitivity, TCGA, spatial |
